...
exposure_df = exposure_df[['permid',
 'issuer_name','maxexp_abortifacents_part_before','maxexp_abortifacents_part_after','maxexp_alchol_prod_before','maxexp_alchol_prod_after','maxexp_alcohol_part_before','maxexp_alcohol_part_after','maxexp_antip_landmines_part_before','maxexp_antip_landmines_part_after','maxexp_armament_part_before','maxexp_armament_part_after','maxexp_armament_prod_before','maxexp_armament_prod_after','maxexp_artic_oil_part_before','maxexp_artic_oil_part_after','maxexp_chemic_biolog_weapons_part_before','maxexp_chemic_biolog_weapons_part_after','maxexp_cluster_bombs_part_before','maxexp_cluster_bombs_part_after','maxexp_coal_mining_part_before','maxexp_coal_mining_part_after','maxexp_coal_mining_prod_before','maxexp_coal_mining_prod_after','maxexp_coal_power_gen_part_before','maxexp_coal_power_gen_part_after','maxexp_coal_power_gen_prod_before','maxexp_coal_power_gen_prod_after','maxexp_contraceptives_part_before','maxexp_contraceptives_part_after','maxexp_embryonic_stem_cell_research_part_before','maxexp_embryonic_stem_cell_research_part_after','maxexp_fossil_fuels_part_before','maxexp_fossil_fuels_part_after','maxexp_fossil_fuels_prod_before','maxexp_fossil_fuels_prod_after','maxexp_gambling_part_before','maxexp_gambling_part_after','maxexp_gambling_prod_before','maxexp_gambling_prod_after','maxexp_gmo_products_part_before','maxexp_gmo_products_part_after','maxexp_gmo_research_part_before','maxexp_gmo_research_part_after','maxexp_nuclear_weapons_part_before','maxexp_nuclear_weapons_part_after','maxexp_oil_sands_part_before','maxexp_oil_sands_part_after','maxexp_oil_sands_prod_before','maxexp_oil_sands_prod_after','maxexp_palm_oil_part_before','maxexp_palm_oil_part_after','maxexp_pornography_part_before','maxexp_pornography_part_after','maxexp_shale_energy_part_before','maxexp_shale_energy_part_after','maxexp_shale_energy_prod_before','maxexp_shale_energy_prod_after','maxexp_small_arms_part_before','maxexp_small_arms_part_after','maxexp_stem_cell_research_before','maxexp_stem_cell_research_after','maxexp_tobacco_part_before','maxexp_tobacco_part_after','maxexp_tobacco_prod_before','maxexp_tobacco_prod_after','maxexp_white_phosporus_part_before','maxexp_white_phosporus_part_after','maxexp_nuclear_weapons_prod_before','maxexp_nuclear_weapons_prod_after','maxexp_cluster_bombs_prod_before','maxexp_cluster_bombs_prod_after','maxexp_thermal_coal_prod_before','maxexp_thermal_coal_prod_after','maxexp_gas_fuels_prod_before','maxexp_gas_fuels_prod_after',                   
 'maxexp_gas_fuels_part_before','maxexp_gas_fuels_part_after', 'maxexp_oil_fuels_prod_before','maxexp_oil_fuels_prod_after','maxexp_oil_fuels_part_before','maxexp_oil_fuels_part_after']]
...
controv_df = controv_df[['permid',
 'issuer_name', 'controv_variation', 'any_critical_controversy_after', 'variation_any_critical_controversy', 'variation_controv_access_to_basic_services', 'variation_controv_accounting_and_taxation', 'variation_controv_animal_welfare', 'variation_controv_animal_welfare_sc', 'variation_controv_anticompetitive_practices', 'variation_controv_bribery_and_corruption', 'variation_controv_bribery_and_corruption_sc', 'variation_controv_business_ethics', 'variation_controv_business_ethics_sc', 'variation_controv_carbon_impact_of_products', 'variation_controv_community_relations', 'variation_controv_community_relations_sc', 'variation_controv_corporate_governance', 'variation_controv_data_privacy_and_security', 'variation_controv_emissions_effluents_and_waste', 'variation_controv_emissions_effluents_and_waste_sc', 'variation_controv_employees_human_rights', 'variation_controv_employees_human_rights_sc', 'variation_controv_energy_use_and_ghg_emissions', 'variation_controv_energy_use_and_ghg_emissions_sc', 'variation_controv_environmental_impact_of_products', 'variation_controv_intellectual_property', 'variation_controv_labour_relations', 'variation_controv_labour_relations_sc', 'variation_controv_land_use_and_biodiversity', 'variation_controv_land_use_and_biodiversity_sc', 'variation_controv_lobbying_and_public_policy', 'variation_controv_marketing_practices', 'variation_controv_media_ethics', 'variation_controv_occupational_health_and_safety', 'variation_controv_occupational_health_and_safety_sc', 'variation_controv_quality_and_safety', 'variation_controv_sanctions', 'variation_controv_social_impact_of_products', 'variation_controv_society_human_rights', 'variation_controv_society_human_rights_sc', 'variation_controv_water_use', 'variation_controv_water_use_sc', 'variation_controv_weapons', 'controv_access_to_basic_services_before',                                                    
 'controv_access_to_basic_services_after', 'controv_accounting_and_taxation_before', 'controv_accounting_and_taxation_after', 'controv_animal_welfare_before', 'controv_animal_welfare_after', 'controv_animal_welfare_sc_before', 'controv_animal_welfare_sc_after', 'controv_anticompetitive_practices_before', 'controv_anticompetitive_practices_after', 'controv_bribery_and_corruption_before', 'controv_bribery_and_corruption_after', 'controv_bribery_and_corruption_sc_before', 'controv_bribery_and_corruption_sc_after', 'controv_business_ethics_before', 'controv_business_ethics_after', 'controv_business_ethics_sc_before', 'controv_business_ethics_sc_after', 'controv_carbon_impact_of_products_before', 'controv_carbon_impact_of_products_after', 'controv_community_relations_before', 'controv_community_relations_after', 'controv_community_relations_sc_before', 'controv_community_relations_sc_after', 'controv_corporate_governance_before', 'controv_corporate_governance_after', 'controv_data_privacy_and_security_before', 'controv_data_privacy_and_security_after', 'controv_emissions_effluents_and_waste_before', 'controv_emissions_effluents_and_waste_after', 'controv_emissions_effluents_and_waste_sc_before', 'controv_emissions_effluents_and_waste_sc_after', 'controv_employees_human_rights_before', 'controv_employees_human_rights_after', 'controv_employees_human_rights_sc_before', 'controv_employees_human_rights_sc_after', 'controv_energy_use_and_ghg_emissions_before', 'controv_energy_use_and_ghg_emissions_after', 'controv_energy_use_and_ghg_emissions_sc_before', 'controv_energy_use_and_ghg_emissions_sc_after', 'controv_environmental_impact_of_products_before', 'controv_environmental_impact_of_products_after', 'controv_intellectual_property_before', 'controv_intellectual_property_after', 'controv_labour_relations_before', 'controv_labour_relations_after', 'controv_labour_relations_sc_before', 'controv_labour_relations_sc_after', 'controv_land_use_and_biodiversity_before', 'controv_land_use_and_biodiversity_after', 'controv_land_use_and_biodiversity_sc_before', 'controv_land_use_and_biodiversity_sc_after', 'controv_lobbying_and_public_policy_before', 'controv_lobbying_and_public_policy_after', 'controv_marketing_practices_before', 'controv_marketing_practices_after', 'controv_media_ethics_before', 'controv_media_ethics_after', 'controv_occupational_health_and_safety_before', 'controv_occupational_health_and_safety_after', 'controv_occupational_health_and_safety_sc_before', 'controv_occupational_health_and_safety_sc_after', 'controv_quality_and_safety_before', 'controv_quality_and_safety_after', 'controv_sanctions_before', 'controv_sanctions_after', 'controv_social_impact_of_products_before', 'controv_social_impact_of_products_after', 'controv_society_human_rights_before', 'controv_society_human_rights_after', 'controv_society_human_rights_sc_before', 'controv_society_human_rights_sc_after', 'controv_water_use_before', 'controv_water_use_after', 'controv_water_use_sc_before', 'controv_water_use_sc_after', 'controv_weapons_before', 'controv_weapons_after']] # e.	Select the Columns with the variation that will be add to the final Dataframe.  
...
strategies_df = strategies_df [['permid','issuer_name','variation_estrategias','variation_art_8_basicos','variation_cs_001_sec','variation_cs_002_ec','variation_cs_003_sec','variation_gp_esccp_22',                   'variation_str_001_s','variation_str_002_ec','variation_str_003_ec','variation_str_003b_ec','variation_str_004_asec','variation_str_005_ec','variation_str_006_sec','variation_str_007_sect','art_8_basicos_before',                  'art_8_basicos_after','cs_001_sec_before',                   'cs_001_sec_after','cs_002_ec_before','cs_002_ec_after','cs_003_sec_before','cs_003_sec_after','str_001_s_before','str_001_s_after','str_002_ec_before','str_002_ec_after','str_003_ec_before','str_003_ec_after','str_004_asec_before','str_004_asec_after','str_005_ec_before','str_005_ec_after','str_006_sec_before','str_006_sec_after','str_007_sect_before','str_007_sect_after','str_003b_ec_before','str_003b_ec_after','gp_esccp_22_before','gp_esccp_22_after']]

...
INPUT_PATH = BASE_DIRECTORY + rf'\raw_dataset\{DATE}01_Production\{DATE}01_Equities_feed_new_strategies_filtered_old_names_iso_permId.csv'
# define OUTPU_PATH DIRECTORY:
OUTPUT_PATH = BASE_DIRECTORY + rf'\ficheros_tratados\{DATE}01_Equities_feed_IssuerLevel_sinOVR.xlsx' # naming 20240901_Equities_feed_IssuerLevel_sinOVR

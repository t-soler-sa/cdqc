...
def main():
    ...
    path_dir = Path(
        rf"C:\Users\n740789\Documents\clarity_data_quality_controls\log\{today}_logs\update-ovr-db-active-col"
    )
    path_in = path_dir / f"update-ovr-db-active-col_{today}.log"
    logger.info(f"Filtering log: {path_in}")
    path_out = path_dir / "update-ovr-db-active-col-filtered.log"
